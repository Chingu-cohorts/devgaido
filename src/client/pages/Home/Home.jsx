  ...
  <div>
    ...
    <div className="home-hero flex items-center justify-center bg-cover relative" style={{ backgroundImage: "url('/img/compass.jpg')" }}>
      <div className="flex items-center justify-center bg-primary-25 width-100 height-100">
        <AnimateVisibleChildrenDiv speed={0.7} stagger={0.1} className="flex flex-wrap width-60 width-70-below-d1 width-90-below-t">
          <h1 className="h2-below-d1 h3-below-t c-white width-100 wider">LEARN WEB DEVELOPMENT</h1>
          <h1 className="h2-below-d1 h3-below-t c-white wider margin-bottom-big margin-bottom-small-below-t width-100">THE DEVGAIDO WAY</h1>
          <p className="h4 h5-below-d1 c-white">Whether you&#039;re just starting out or want to brush up a certain skill:</p>
          ...
          <div className="margin-top-small width-100">
            ...
            <LinkButton className="button--white-clear" icon="icon-search" href="/library">Explore Library</LinkButton>
          </div>
    ...
    <AnimateVisibleChildrenDiv speed={0.7} stagger={0.2} alternate className="container">
      <section className="flex flex-column-below-t margin-top-huge">
        <LazyLoad once placeholder={<LoadingPlaceholder />}>
          <img className="width-50 width-100-below-t height-auto border-round" src="/img/discover.jpg" alt=""
      ...
      <section className="flex flex-column-below-t margin-top-huge">
        <div className="margin-right-small margin-top-small right order-2-below-t width-50 width-100-below-t">
          <h1 className="h2-below-d1 h3-below-t c-primary wider right">Learn</h1>
        ...
        <LazyLoad once placeholder={<LoadingPlaceholder />}>
          <img className="width-50 width-100-below-t height-auto border-round order-1-below-t" src="/img/learn.jpg" alt=""
      ...
      <section className="flex flex-column-below-t margin-top-huge">
        <LazyLoad once placeholder={<LoadingPlaceholder />}>
          <img className="width-50 width-100-below-t height-auto border-round" src="/img/practise.jpg" alt=""
      ...
      <section className="flex flex-column-below-t margin-top-huge margin-bottom-huge">
        <div className="margin-right-small margin-top-small right order-2-below-t width-50 width-100-below-t">
          <h1 className="h2-below-d1 h3-below-t c-primary wider right">Build</h1>
        ...
        <LazyLoad once placeholder={<LoadingPlaceholder />}>
          <img className="width-50 width-100-below-t height-auto border-round order-1-below-t" src="/img/build.jpg" alt=""
