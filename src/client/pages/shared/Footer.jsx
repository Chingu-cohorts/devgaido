  ...
  <footer>
    <div className="container padding-vertical-big flex justify-space-between">
      ...
      <div className="flex">
        ...
        <Link to="/terms" className="uppercase margin-right-small">Terms</Link>
        <Link to="/disclaimer" className="uppercase margin-right-small">Disclaimer</Link>
        <Link to="/privacy" className="uppercase margin-right-small">Privacy</Link>
      ...
      <div className="flex h2">
        ...
        <a href="https://facebook.com/devgaido" target="_blank" rel="noopener noreferrer" className="margin-right-small"><i className="fa fa-facebook" /></a>
        ...
        <a href="https://youtube.com/devgaido" target="_blank" rel="noopener noreferrer" className="uppercase margin-right-small"><i className="fa fa-youtube" /></a>
      </div>
    </div>
  </footer>
);
